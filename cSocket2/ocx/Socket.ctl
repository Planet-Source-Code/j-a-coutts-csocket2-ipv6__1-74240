...
'Don't forget to change CSocket class
...
'Our socket
Private WithEvents cmSocket As cSocket2
Attribute cmSocket.VB_VarHelpID = -1

Private Sub UserControl_Initialize()
'create an instance of CSocket
Set cmSocket = New cSocket2
End Sub

Private Sub UserControl_Terminate()
'destroy instance of CSocket
...
Public Property Get GetIPFromHost(HostName As String, Optional UseIPv6 As Long) As String
    GetIPFromHost = cmSocket.GetIPFromHost(HostName, "0", UseIPv6)
End Property
...
Attribute Bind.VB_Description = "Binds socket to specific port and adapter"
    cmSocket.Bind2 LocalPort, LocalIP
End Sub
...
Attribute Connect.VB_Description = "Connect to the remote computer"
    cmSocket.Connect2 RemoteHost, RemotePort
End Sub
